...
```sh
rbd -p backups ls
rbs snap ls backups/volume-21bca525-f728-4484-a59c-62b134db6a08.backup.19b90a2c-1ae0-4833-8ca6-8ca270f1c1cf
```
...
```sh
cinder --insecure snapshot-create --force 21bca525-f728-4484-a59c-62b134db6a08 --name snap01-vmcent
```
