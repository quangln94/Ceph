...
- Khi thực hiện tạo các bản backup hay snapshot cho volume thì trong image tương ứng với volume đó dưới Ceph sẽ tạo ra các bản backup và snapshot tương ứng.
- Khi tạo ra các bản backup full thì trong pool backup sẽ tạo ra các image độc lập và các image này sẽ chứa bản snapshot của chính nó.
- Khi thực hiện tạo các bản backup-incremental thì các bản backup-incremental này sẽ là các bản snapshot của image backupfull gần nhất mà hệ thống Ceph tạo ra.
